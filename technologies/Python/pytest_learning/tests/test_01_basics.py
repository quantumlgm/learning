...
def test_currency_exchange_properly():
    result = currency_exchange(
        in_valute="USD", from_valute="RUB", currency=100, exchange_rate=78.28
    )
...
def test_check_all_results():
    result = currency_exchange(
        in_valute="USD", from_valute="RUB", currency=70, exchange_rate=0.5
    )
    ...
    result = currency_exchange(
        in_valute="USD", from_valute="RUB", currency=2, exchange_rate=10
    )
